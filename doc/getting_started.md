...
OpenAlea is built by a community of researchers and labs around the world, led by three french research institutes : CIRAD, INRAE, and Inria.

## What's in OpenAlea ?
* **formalisms** used to represent plant architecture (MTG), visualize it in 3D (plantgl), simulate the growth and 
development of plants (LPy), and analyse its structure (StructureAnalysis)
